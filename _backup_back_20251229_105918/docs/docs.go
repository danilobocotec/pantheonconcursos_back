...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/meus-cursos": {
            "get": {
                ...
                "summary": "Listar meus cursos agrupados",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.CourseSubject"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateCourseSubjectRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/meus-cursos/assuntos/{assunto_id}/modulos": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "summary": "Criar modulo dentro de um assunto",
                "parameters": [
                    {
                        "type": "string",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateCourseModuleRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.CourseModule"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateCourseSubjectRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateCourseItemRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.CourseItem"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/meus-cursos/modulos": {
            "post": {
                ...
                "summary": "Criar modulo sem assunto",
                "parameters": [
                    {
                        "description": "Modulo",
                        "name": "request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateCourseModuleRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.CreateCourseModuleRequest": {
            "type": "object",
            "required": [
                "modulo"
            ],
        ...
        "model.CreateCourseSubjectRequest": {
            "type": "object",
            "required": [
                "assunto"
            ],
        ...
        "model.UpdateCourseModuleRequest": {
            "type": "object",
            "properties": {
                "modulo": {
                    "type": "string",
        ...
        "model.UpdateCourseSubjectRequest": {
            "type": "object",
            "properties": {
                "assunto": {
                    "type": "string",
